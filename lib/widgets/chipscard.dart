...
class ChipsCard extends StatefulWidget {
  ...
  ChipsCard(this.index, this.player, this._handler, {Key? key}) : super(key: key);
          ...
          Container(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                ...
                child: Text(denominationList[index].toString()), // icon of the button
              ),
            ),
          ),
          Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    width: screenWidth * buttonWidth,
                    alignment: Alignment.center,
                    child: Text("$quantity", style: const TextStyle(color: Colors.black, fontSize: 20)),
                  ),
                  SizedBox(
                    width: screenWidth * buttonWidth,
                    child: ElevatedButton(
